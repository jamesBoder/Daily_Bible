...
export const THEMES: ThemeDefinition[] = [
  ...
  },
  {
    id: 'sanctuary',
    name: 'Sanctuary',
    description: 'Soft sage green and honey gold. Morning light through the forest canopy.',
    isDark: false,
    unlockCost: 500,
    previewColors: { background: '#dce8c6', foreground: '#1a2e0a', accent: '#a06c18', surface: '#e4eed2' },
  },
  {
    id: 'desert-sand',
    name: 'Desert Sand',
