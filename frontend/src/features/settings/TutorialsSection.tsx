      ...
      <div className="space-y-2">
        {TUTORIALS.map((tut) => {
          ...
          return (
            <button
              key={tut.id}
              className="w-full flex items-center gap-3 px-4 py-3 rounded-xl bg-[var(--theme-surface)] hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors text-left group focus:outline-none focus:ring-2 focus:ring-primary-500"
